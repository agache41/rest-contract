...
public abstract class AbstractResourceServiceImpl<TO extends PrimaryKey<PK> & TransferObject<TO, ENTITY>, ENTITY extends PrimaryKey<PK>, PK> implements ResourceService<TO, PK>, InitializingBean {
    ...
    public TO postById(@RequestBody final PK id) {
        return this.get(id);
    }
    ...
    public List<TO> postByIdsAsList(@RequestBody final List<PK> ids) {
    ...
    public List<TO> postFilterContentEqualsAsList(@RequestBody final Map<String, Object> value,
                                                  @RequestParam(name = "firstResult", required = false) final Integer firstResult,
                                                  @RequestParam(name = "maxResults", required = false) final Integer maxResults) {
        return this.getDataBinder()
    ...
    public List<TO> postFilterContentInAsList(@RequestBody final Map<String, List<Object>> values,
                                              @RequestParam(name = "firstResult", required = false) final Integer firstResult,
                                              @RequestParam(name = "maxResults", required = false) final Integer maxResults) {
        return this.getDataBinder()
    ...
    public TO post(@RequestBody final TO to) {
    ...
    public List<TO> postListAsList(@RequestBody final List<TO> toList) {
    ...
    public TO put(@RequestBody final TO to) {
    ...
    public List<TO> putListAsList(@RequestBody final List<TO> toList) {
    ...
    public void deleteByIds(@RequestBody final List<PK> ids) {
        this.getDataBinder()
            .removeByIds(ids);
    }
     ...
     */
    public abstract DataBinder<TO, ENTITY, PK> getDataBinder();
//    {
...
//    }
     ...
     * @return the data binder
     */
    public abstract DataAccess<ENTITY, PK> getDataAccess();
//    {
